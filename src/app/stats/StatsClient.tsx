    ...
    return (
        <StackVertical gap="lg" className="pt-4">
            <div className="space-y-1">
                ...
                <Text size="2xl" weight="bold" className="pride-text leading-none">
                    {total}
                </Text>
            </div>
            ...
            <div className="space-y-6">
                {data.map((item, i) => (
                    ...
                    >
                        ...
                        <div className="h-1.5 w-full bg-secondary/30 rounded-sm overflow-hidden border border-slate-200/10 dark:border-slate-800/10">
                            <motion.div
                                initial={{ width: 0 }}
