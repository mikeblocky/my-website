      ...
      >
              <section id={SECTION_IDS.INTRODUCTION}>
                <StackVertical gap="md">
                  ...
                  <Text>
                    My suggestion: complete <Link href={`#${SECTION_IDS.MATH.MATH}`} className="text-blue-500 hover:underline"><b>[1]</b></Link>, get some basic understanding of Python (and some PyTorch too if you have time) in <Link href={`#${SECTION_IDS.PROGRAMMING.PROGRAMMING}`} className="text-blue-500 hover:underline"><b>[2]</b></Link> (you do not need to master Python or PyTorch! learn as you go!), complete the 3B1B playlist from <Link href={`#${SECTION_IDS.ML_STUFF.NN_3B1B}`} className="text-blue-500 hover:underline"><b>[3.1.1]</b></Link> — make sure you have a basic high-level understanding of the concepts — and start <Link href={`#${SECTION_IDS.ML_STUFF.ML_HANDS_ON}`} className="text-blue-500 hover:underline"><b>[3.2]</b></Link>. The rest can be done concurrently with something else. Even if you skip some parts, make sure you come back to complete it. When I say this, I'm not talking about the course, but the topic!
                  </Text>
              ...
              <section>
                  ...
                  <Text>Here's the <Link href="https://www.coursera.org/specializations/mathematics-for-machine-learning-and-data-science" target="_blank" className="hover:underline text-blue-500 font-bold">specialization link</Link>.</Text>
                  ...
                  <Text>Here's the <Link href="https://www.3blue1brown.com/topics/linear-algebra" target="_blank" className="hover:underline text-blue-500 font-bold">playlist link</Link>.</Text>
                  ...
                  <Text>Here's the <Link href="https://www.3blue1brown.com/topics/differential-equations" target="_blank" className="hover:underline text-blue-500 font-bold">playlist link</Link>.</Text>
                  ...
                  <Text>Here's the <Link href="https://www.3blue1brown.com/topics/calculus" target="_blank" className="hover:underline text-blue-500 font-bold">playlist link</Link>.</Text>
                  ...
                  <Text>You can take a look at how this site works <Link href="https://www.mathacademy.com/how-it-works" target="_blank" className="hover:underline text-blue-500 font-bold">here</Link>. I am not affiliated with this site by any means; I just think it's that good.</Text>

                  <Text>Here's the <Link href="https://www.mathacademy.com/courses/mathematics-for-machine-learning" target="_blank" className="hover:underline text-blue-500 font-bold">course link</Link>.</Text>
                </StackVertical>
              </section>
              ...
              <section>
                ...
                <StackVertical gap="md">
                  ...
                  <Text>Here's the <Link href="https://github.com/dabeaz-course/practical-python" target="_blank" className="hover:underline text-blue-500 font-bold">course link</Link>.</Text>
                  ...
                  <Text>Here's the <Link href="https://www.learnpytorch.io/" target="_blank" className="hover:underline text-blue-500 font-bold">course link</Link> and the <Link href="https://youtu.be/Z_ikDlimN6A" target="_blank" className="hover:underline text-blue-500 font-bold">YouTube video link</Link>.</Text>

                  <Ruler weight='thin' />

                  <TextHeading as="h3">2.3 Official NumPy Docs</TextHeading>
                  <Text>NumPy is a very important library for manipulating data (mostly in the form of arrays when it comes to machine learning). Alongside PyTorch, this is another library that we must know about. PyTorch and NumPy may seem similar, but the main difference lies in the computation: Pytorch tensors (think of them as n-dimensional matrices) are similar to numpy arrays, but can also be operated on GPU. Numpy arrays are mainly used in typical machine learning algorithms (such as k-means or Decision Tree in scikit-learn) whereas PyTorch tensors are mainly used in deep learning which requires heavy matrix computation. You can take a look at this <Link href="https://www.kaggle.com/code/amirmotefaker/pytorch-vs-numpy" target="_blank" className="hover:underline text-blue-500 font-bold">document</Link> for a quick comparison.</Text>

                  <Text>I recommend completing the <Link href="https://numpy.org/doc/stable/user/absolute_beginners.html" target="_blank" className="hover:underline text-blue-500 font-bold">absolute basics</Link> and the <Link href="https://numpy.org/doc/stable/user/basics.html" target="_blank" className="hover:underline text-blue-500 font-bold">fundamentals</Link> sections from the official NumPy documentation to get started.</Text>

                  <Ruler weight='thin' />

                  <TextHeading as="h3" id={SECTION_IDS.PROGRAMMING.PYTORCH_OFFICIAL_DOCS}>2.4 Official PyTorch Docs</TextHeading>
                  <Text>This is the official PyTorch documentation. I highly recommend firstly going through the PyTorch book by Daniel Bourke from <Link href={`#${SECTION_IDS.PROGRAMMING.PYTORCH_ZERO_TO_MASTERY}`} className="hover:underline text-blue-500 font-bold">above</Link>, and then using this documentation as a reference. We do not necessarily need to learn or know everything from it; we just need to know where to look at when we need to.</Text>
                  <Text>Here's the <Link href="https://pytorch.org/docs/stable/index.html" target="_blank" className="hover:underline text-blue-500 font-bold">official documentation link</Link>.</Text>

                  <Ruler weight='thin' />
                  
                  <TextHeading as="h3" id={SECTION_IDS.PROGRAMMING.ADVANCED_PYTHON}>2.5 Advanced Python Mastery by Dabeaz</TextHeading>
                  <Text>This course can be thought of as a more advanced version of the <Link href={`#${SECTION_IDS.PROGRAMMING.PRACTICAL_PYTHON}`} className="hover:underline text-blue-500 font-bold">Practical Python</Link> course. It is not meant for beginners, but for those who have a good grasp of Python and want to learn more advanced topics; therefore, if you want to skip this one, it is completely fine. That being said, if you want to move beyond writing scripts to writing more sophisticated programs and build a more complete mental model of the Python language itself and how it works, this is the course for you.</Text>
                  <Text>Here's the <Link href="https://github.com/dabeaz-course/python-mastery" target="_blank" className="hover:underline text-blue-500 font-bold">course link</Link>.</Text>
              ...
              <section id={SECTION_IDS.ML_STUFF.ML_STUFF}>
                ...
                <StackVertical gap="md">
                  ...
                  <Text>Here's the <Link href="https://www.3blue1brown.com/topics/neural-networks" target="_blank" className="hover:underline text-blue-500 font-bold">site link</Link> and the <Link href="https://www.youtube.com/playlist?list=PLZHQObOWTQDNU6R1_67000Dx_ZCJB-3pi" target="_blank" className="hover:underline text-blue-500 font-bold">YouTube playlist link</Link>.</Text>
                  ...
                  <Text>Here's the <Link href="https://www.coursera.org/specializations/machine-learning-introduction" target="_blank" className="hover:underline text-blue-500 font-bold">course link</Link>.</Text>
                  
                  <Ruler weight='thin' />
                  
                  <TextHeading as="h4">3.1.3 ML Playlist by Statquest</TextHeading>
                  <Text>I like to think of Josh Starmer's channel as my go-to for learning anything machine learning or statistics related whenever I run into a concept that I find difficult to understand. I believe his videos are interactive and intuitive, and I use his Statquest videos on ML for reference (just like the <Link href={`#${SECTION_IDS.PROGRAMMING.PYTORCH_OFFICIAL_DOCS}`} className="hover:underline text-blue-500 font-bold">PyTorch docs</Link>). I recommend you do this as well if you feel like it :)</Text>
                  
                  <Text>Here's the <Link href="https://www.youtube.com/playlist?list=PLblh5JKOoLUICTaGLRoHQDuF_7q2GfuJF" target="_blank" className="hover:underline text-blue-500 font-bold">YouTube playlist link</Link>.</Text>
                  ...
                  <Text>The topics that this book covers ranges from traditional machine learning concepts (covering the fundamental concepts surrounding machine learning, including preprocessing the data, model evaluation, hyperparameter tuning, etc.) making use of mainly <Link href="https://scikit-learn.org/stable/" target="_blank" className="hover:underline text-blue-500 font-bold">scikit-learn</Link> to deep learning (such as CNNs, RNNs, Transformers, parallelization, GNNs, Reinforcement Learning, etc.) using <Link href={`#${SECTION_IDS.PROGRAMMING.PYTORCH_OFFICIAL_DOCS}`} className="hover:underline text-blue-500 font-bold">PyTorch</Link>. It's a ridiculously packed book, and I highly recommend it.</Text>


                  <Text>If you are interested in knowing more about the topics covered in this book, you can take a look at the <Link href="https://sebastianraschka.com/books/machine-learning-with-pytorch-and-scikit-learn/" target="_blank" className="hover:underline text-blue-500 font-bold">book link</Link>, <Link href="https://sebastianraschka.com/books/machine-learning-with-pytorch-and-scikit-learn/#preface" target="_blank" className="hover:underline text-blue-500 font-bold">its detailed table of contents</Link>, and <Link href="https://sebastianraschka.com/blog/2022/ml-pytorch-book.html" target="_blank" className="hover:underline text-blue-500 font-bold">the blog by the author</Link> explaining the book content.</Text>
                  ...
                  <Text>Here's the <Link href="https://github.com/karpathy/nn-zero-to-hero" target="_blank" className="hover:underline text-blue-500 font-bold">link to the series</Link>.</Text>
                </StackVertical>
              </section>
              ...
              <section id={SECTION_IDS.RESOURCES.RESOURCES}>
                ...
                <StackVertical gap="md">
                  <Text>
                    Do some small-scale side projects too! <Link href="https://www.kaggle.com/" target="_blank" className="hover:underline text-blue-500 font-bold">Kaggle</Link> is nice. Also, try to consume as much as you can from people like <Link href="https://sebastianraschka.com/" target="_blank" className="hover:underline text-blue-500 font-bold">Sebastian Raschka</Link> in addition to <Link href="https://karpathy.ai/" target="_blank" className="hover:underline text-blue-500 font-bold">Andrej Karpathy</Link>.
                  </Text>
                  ...
                  <List marker='decimal' spacing='relaxed'>
                    <ListItem><Link href="https://udlbook.github.io/udlbook/" target="_blank" className="hover:text-blue-500 hover:underline">Understanding Deep Learning by Simon Prince</Link></ListItem>
                    <ListItem><Link href="https://www.sscardapane.it/alice-book/" target="_blank" className="hover:text-blue-500 hover:underline">Alice's Adventures in Differentiable Wonderland by Scardapane</Link></ListItem>
                    <ListItem><Link href="https://github.com/chiphuyen/dmls-book" target="_blank" className="hover:text-blue-500 hover:underline">Designing Machine Learning Systems by Chip Huyen</Link></ListItem>
                    <ListItem><Link href="https://www.manning.com/books/build-a-large-language-model-from-scratch" target="_blank" className="hover:text-blue-500 hover:underline">Build a Large Language Model from Scratch by Sebastian Raschka</Link></ListItem>
                  </List>
                  <Ruler color="colorless" marginTop="sm" marginBottom="none"/>
                  <Text>
                  ...
                  <List marker='decimal' spacing='relaxed'>
                    <ListItem><Link href="https://github.com/dair-ai/ML-Papers-Explained" target="_blank" className="hover:text-blue-500 hover:underline">ML Papers Explained by dair.ai</Link></ListItem>
                    <ListItem><Link href="https://github.com/labmlai/annotated_deep_learning_paper_implementations" target="_blank" className="hover:text-blue-500 hover:underline">Annotated Deep Learning Paper Implementations by labml.ai</Link></ListItem>
                  </List> 

                  <Ruler color="colorless" marginTop="sm" marginBottom="none"/>
                  
                  <Text>
                    I also really like <Link href="https://ml-resources.vercel.app/" target="_blank" className="hover:underline text-blue-500 font-bold">this site</Link> that lists out tons of ml resources created by learners and experts alike.
                  </Text>

                  <Text>
                    Lastly, if you want to be a part of the community of driven learners, you can take a look at all the people I follow on <Link href="https://x.com/sumitdotml/following" target="_blank" className="hover:underline text-blue-500 font-bold">Twitter</Link>. These are some of the most active and amazing people I've met online, and I've learned a lot from them.
                  </Text>
