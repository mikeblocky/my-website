...
<Text variant="muted" size="xs" className="text-center mt-4 mb-8">A simple illustration of a Directed Acyclic Graph (DAG). <Link href="https://thenlp.space/blog/graph-convolutional-network-for-dummies" target="_blank" className="underline text-blue-400 hover:text-blue-600">Source</Link>.</Text>
